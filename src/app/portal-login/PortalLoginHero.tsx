...
export function PortalLoginHero() {
  return (
    <section className="vo-login-hero relative hidden min-h-screen flex-1 overflow-hidden lg:flex lg:flex-col">
      ...
      <div
        className="vo-login-glow-orb pointer-events-none absolute -right-24 top-1/4 h-80 w-80 rounded-full bg-teal-500/20 blur-3xl"
        aria-hidden
      />
      <div
        className="vo-login-glow-orb pointer-events-none absolute -left-16 bottom-1/4 h-64 w-64 rounded-full bg-teal-300/15 blur-3xl"
        style={{ animationDelay: "-3s" }}
        aria-hidden
      />
      <div
        className="vo-login-glow-orb pointer-events-none absolute left-1/3 top-2/3 h-52 w-52 rounded-full bg-sky-400/12 blur-3xl"
