...
export default async function PortalLoginPage({ searchParams }: PortalLoginPageProps) {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#0b0f19] text-white lg:flex-row">
      ...
      <section className="relative hidden min-h-screen flex-1 lg:flex">
        <Image src="/login-hero.png" alt="" fill priority className="object-cover object-center" sizes="52vw" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0b0f19]/85 via-[#0b0f19]/45 to-[#0b0f19]/25" />
        <div className="relative z-[1] mt-auto max-w-xl px-10 pb-16 xl:px-16 xl:pb-20">
          ...
          <p className="mt-6 text-2xl leading-relaxed text-slate-200/95">
